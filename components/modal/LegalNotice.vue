<template>
  <CommonModal v-model:opened="modalDisplayed" :initial-focus="checkbox" :closable="false">
    <DialogTitle as="div" class="modal-title">Magma Bridge Portal is live on beta</DialogTitle>
    <p class="modal-text">
    ...
    <CommonCheckboxWithText ref="checkbox" v-model="warningChecked" class="mt-3">
      I agree to the <a href="https://magma.foundation/terms" target="_blank" class="checkbox-link">Terms of Service</a> and
      <a href="https://magma.foundation/privacy" target="_blank" class="checkbox-link">Privacy Policy</a>
